...
| RESOLVED / VERIFY | Advance duplicate guard เดิมไม่ atomic | เพิ่ม deterministic `submissionKey` และ Firestore transaction สำหรับ submission ใหม่; legacy records ยังใช้ lookup | ต้องยืนยัน behavior ด้วย emulator/test account และรองรับ legacy ให้ครบ | เพิ่ม emulator/production test evidence และคงแผน audit trail |
